...
//		cam.startAutomaticCapture("cam1");
		...
		// // frame = NIVision.imaqdxc
		// binaryFrame = NIVision.imaqCreateImage(ImageType.IMAGE_U8, 0);
		// criteria[0] = new
		// NIVision.ParticleFilterCriteria2(NIVision.MeasurementType.MT_AREA_BY_IMAGE_AREA,
		// AREA_MINIMUM, 100.0, 0, 0);

	}

	public void initSecondCam() {
	...
	public void initDefaultCommand() {
		...
		// setDefaultCommand(new IsVision());
		// setDefaultCommand(new SecondCamera());
	}

	public void AnalyzeVision() {
		...
		// grab an image, which will be provided to the cameraserver
